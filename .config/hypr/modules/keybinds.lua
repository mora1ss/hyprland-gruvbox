...
hl.bind(mainMod .. " + N", hl.dsp.exec_cmd("hyprshot -m region -z"))
hl.bind(mainMod .. " + SHIFT + N", hl.dsp.exec_cmd("hyprshot -m output"))
hl.bind(mainMod .. " + ALT + N", hl.dsp.exec_cmd("hyprshot -m window"))
